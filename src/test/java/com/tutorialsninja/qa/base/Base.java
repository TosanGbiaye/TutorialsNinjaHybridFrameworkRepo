...
public class Base {
	...
	public WebDriver initializeBrowserAndOpenApplicationURL(String browserName) {
		...
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(Utils.CHAR_REPLACEMENT));
		driver.manage().timeouts().pageLoadTimeout(Duration.ofSeconds(Utils.CHAR_REPLACEMENT));
